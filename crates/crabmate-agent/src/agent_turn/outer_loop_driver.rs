...
//! 见 `docs/design/per_state_machine_consolidation.md` P/R/E 外层；IO 仍在根包。
...
pub struct OuterLoopDriver {
    pub phase: OuterLoopIterationPhase,
    pub last_reflect: Option<ReflectBranchCtl>,
    pub last_exit: Option<OuterLoopIterationExit>,
}
