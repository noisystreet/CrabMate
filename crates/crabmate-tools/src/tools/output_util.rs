...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CommandSpawnErrorStyle {
    /// `title: 无法启动命令（reason）`
    CannotStartCommand,
...
#[must_use]
pub fn merge_process_output(output: &Output, merge: ProcessOutputMerge) -> String {
...
#[must_use]
pub fn format_exited_command_output(
    title: &str,
    exit_code: i32,
    body: &str,
    max_bytes: usize,
...
#[must_use]
pub fn append_notfound_install_hint(
    mut base: String,
    err: &std::io::Error,
...
#[must_use]
pub fn format_spawn_error_with_program(
    title: &str,
    err: &std::io::Error,
...
pub fn cli_missing_install_hint(program: &str) -> Option<&'static str> {
...
#[must_use]
pub fn run_command_output_formatted(
