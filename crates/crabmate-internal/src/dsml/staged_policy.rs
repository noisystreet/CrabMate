...
pub fn strip_staged_planner_message_tool_calls(
    msg: &mut Message,
...
pub fn staged_first_planner_tool_call_total_after_materialize(
    msg: &mut Message,
    materialize_enabled: bool,
) -> usize {
    scan_after_staged_handling(
...
pub fn staged_no_tools_materialized_count(
    msg: &mut Message,
    materialize_enabled: bool,
    round_hint: &str,
) -> usize {
