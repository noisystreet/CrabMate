...
- Debug / troubleshooting: see **`docs/DEBUG.md`** (Chinese, with English companion **`docs/en/DEBUG.md`**), including **`AGENT_WEB_DISABLE_MARKDOWN`** + **`GET /web-ui`** for raw-text Web bubbles (restart `serve`; no TOML key), logging, `doctor`, SSE alignment, and related **`docs/CONFIGURATION.md`** links.
