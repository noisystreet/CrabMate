...
- **`cargo test golden_sse_control`**（当改动 `fixtures/sse_control_golden.jsonl`、`crates/crabmate-sse-protocol/control_classify.rs` 或 `frontend/src/sse_dispatch.rs` 时由钩子条件触发）
