...
**关联**：运行时行为以 **`docs/工具说明.md`** 中 **`workflow_execute` / `workflow_validate`**、**`docs/开发文档.md`** 中 **`agent::workflow`** 与 **`agent_turn` / 分阶段规划** 为准；本文定义**能力边界**与**推荐演进方向**，避免与现有 DAG 语义 silently 分叉。  
