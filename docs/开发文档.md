...
| **L5 Web 本轮 Skills** | 工作区 Skills + **当前用户消息** top-k | Web **`build_messages_for_turn`**（新会话与续聊刷新首条 `system` 时） | **`context_bootstrap/prompt_compose.rs`** · **`web/chat_handlers/chat/turn_build.rs`** |
