...
- [ ] **Client pin crates.io**: official Client uses `crabmate = { version = "0.5.1", default-features = false, features = ["protocol"] }` (git pin optional). Server is published: [crates.io/crates/crabmate](https://crates.io/crates/crabmate) **0.5.1**, git **`v0.5.1`**. **W3/W4/W5 deferred**.
