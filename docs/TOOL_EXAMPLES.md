...
本文档收录 **内置工具说明**、**工具参数 JSON 示例**、工作流占位符说明、发布检查常见失败处理，以及文件/目录类工具示例。完整工具表与实现位置见 [`DEVELOPMENT.md`](DEVELOPMENT.md) 与 `src/tools/`。
