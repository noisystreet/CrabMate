...
**关联文档**：`docs/design/archive/分层多智能体架构.md`（历史/归档）、`docs/design/agent_state_management.md`；全局会话同步管道与裁剪要点见 **`docs/design/context_trimming_scheme.md`**（本文侧重 ReAct 循环裁剪，落地时应与其对齐）。
