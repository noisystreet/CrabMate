...
pub struct ModalSignals {
    ...
    pub github_embed_open: RwSignal<bool>,
    pub github_embed_url: RwSignal<Option<String>>,
    pub github_embed_title: RwSignal<Option<String>>,
...
impl ModalSignals {
    pub fn new() -> Self {
        Self {
            ...
            github_embed_open: RwSignal::new(false),
            github_embed_url: RwSignal::new(None),
            github_embed_title: RwSignal::new(None),
