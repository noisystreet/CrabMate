...
fn tool_run_group_expanded_block(
    entries: &[(usize, StoredMessage)],
    g: ToolRunGroupSignals,
    n: usize,
    ...
    view! {
        {
            entries
                .iter()
                .map(|(msg_idx, m)| chat_row_for_tool_group(*msg_idx, m.clone(), g))
                .collect_view()
        }
...
fn tool_run_group_collapsed_last_block(
    msg_idx: usize,
    last: StoredMessage,
    g: ToolRunGroupSignals,
    n: usize,
