...
use crate::timeline_scan::{
    TimelineEntry, TimelineKind, collect_timeline_entries, timeline_entry_is_failed,
};
    ...
    view! {
        <li class=item_cls>
            <button
                ...
                prop:title=move || i18n::timeline_panel_jump_title(locale.get())
                prop:aria-label=move || {
                    i18n::timeline_panel_jump_aria(locale.get(), &lbl_aria)
                }
                on:click=move |_| {
...
fn timeline_panel_expanded_region(
    locale: RwSignal<Locale>,
    sessions: RwSignal<Vec<ChatSession>>,
    active_id: RwSignal<String>,
    timeline_panel_expanded: RwSignal<bool>,
...
pub fn timeline_panel_view(
    ...
    view! {
        <div class="timeline-panel-wrap">
            ...
            {timeline_panel_expanded_region(
                locale,
                sessions,
                active_id,
                timeline_panel_expanded,
