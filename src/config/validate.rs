...
/// 拆成多段静态表，降低单函数 `nloc`（`fn-nloc` 棘轮）。
fn u64_range_rows_a1() -> &'static [U64RangeRow] {
    &[
        (
            "max_message_history",
            |b| b.session_ui.max_message_history,
            1,
            1024,
        ),
        (
        ...
        (
            "llm_context_tokens",
            |b| b.llm_sampling.llm_context_tokens,
            0,
            10_000_000,
        ),
        (
            "api_timeout_secs",
            |b| b.llm_http_retry.api_timeout_secs,
            1,
            u64::MAX,
        ),
        (
            "api_max_retries",
            |b| b.llm_http_retry.api_max_retries,
            0,
            10,
        ),
        (
            "api_retry_delay_secs",
            |b| b.llm_http_retry.api_retry_delay_secs,
            1,
            u64::MAX,
        ),
        (
            "weather_timeout_secs",
            |b| b.weather_tool.weather_timeout_secs,
            1,
            u64::MAX,
        ),
        (
            "web_search_timeout_secs",
            |b| b.web_search.web_search_timeout_secs,
            1,
            u64::MAX,
        ),
        (
            "web_search_max_results",
            |b| b.web_search.web_search_max_results,
            1,
            20,
        ),
        (
            "http_fetch_timeout_secs",
            |b| b.http_fetch.http_fetch_timeout_secs,
            1,
            u64::MAX,
        ),
        (
            "http_fetch_max_response_bytes",
            |b| b.http_fetch.http_fetch_max_response_bytes,
            1024,
            4_194_304,
        ),
        (
            "reflection_default_max_rounds",
            |b| b.per_plan_policy.reflection_default_max_rounds,
            1,
            u64::MAX,
        ),
        (
            "plan_rewrite_max_attempts",
            |b| b.per_plan_policy.plan_rewrite_max_attempts,
            1,
            20,
        ),
        (
        ...
        (
            ...
            |b| b.per_plan_policy.final_plan_semantic_check_max_tokens,
            32,
            1024,
        ),
        (
            "cursor_rules_max_chars",
            |b| b.cursor_rules.cursor_rules_max_chars,
            1024,
            1_000_000,
        ),
        (
            "skills_max_chars",
            |b| b.skills.skills_max_chars,
            1024,
            1_000_000,
        ),
        ("skills_top_k", |b| b.skills.skills_top_k, 1, 64),
        (
            "tool_message_max_chars",
            |b| b.tool_transcript.tool_message_max_chars,
            1024,
            1_048_576,
        ),
        (
            "agent_tool_stats_window_events",
            |b| b.agent_tool_stats.agent_tool_stats_window_events,
            16,
            65_536,
        ),
        (
            "agent_tool_stats_min_samples",
            |b| b.agent_tool_stats.agent_tool_stats_min_samples,
            1,
            10_000,
        ),
        (
            "agent_tool_stats_max_chars",
            |b| b.agent_tool_stats.agent_tool_stats_max_chars,
            64,
            32_768,
        ),
    ]
...
fn u64_range_rows_a2() -> &'static [U64RangeRow] {
    &[
        (
            "context_char_budget",
            |b| b.context_pipeline.context_char_budget,
            0,
            50_000_000,
        ),
        (
            "context_min_messages_after_system",
            |b| b.context_pipeline.context_min_messages_after_system,
            1,
            128,
        ),
        (
        ...
        (
            ...
            |b| b.context_pipeline.context_summary_tail_messages,
            4,
            64,
        ),
        (
            "context_summary_max_tokens",
            |b| b.context_pipeline.context_summary_max_tokens,
            256,
            8192,
        ),
        (
            "context_summary_transcript_max_chars",
            |b| b.context_pipeline.context_summary_transcript_max_chars,
            10_000,
            2_000_000,
        ),
        (
            "health_llm_models_probe_cache_secs",
            |b| b.web_api.health_llm_models_probe_cache_secs,
            5,
            86_400,
        ),
        (
            "chat_queue_max_concurrent",
            |b| b.chat_queues_cache.chat_queue_max_concurrent,
            1,
            256,
        ),
        (
            "chat_queue_max_pending",
            |b| b.chat_queues_cache.chat_queue_max_pending,
            1,
            8192,
        ),
        (
            "parallel_readonly_tools_max",
            |b| b.chat_queues_cache.parallel_readonly_tools_max,
            1,
            256,
        ),
        (
            "read_file_turn_cache_max_entries",
            |b| b.chat_queues_cache.read_file_turn_cache_max_entries,
            0,
            4096,
        ),
        (
        ...
        (
            ...
            |b| b.context_bootstrap_inject.agent_memory_file_max_chars,
            256,
            500_000,
        ),
        (
            "living_docs_inject_max_chars",
            |b| b.context_bootstrap_inject.living_docs_inject_max_chars,
            0,
            500_000,
        ),
        (
            "living_docs_file_max_each_chars",
            |b| b.context_bootstrap_inject.living_docs_file_max_each_chars,
            0,
            500_000,
        ),
        (
            "project_profile_inject_max_chars",
            |b| b.context_bootstrap_inject.project_profile_inject_max_chars,
            0,
            500_000,
        ),
        (
        ...
        (
            ...
            |b| b.tool_call_explain.tool_call_explain_min_chars,
            1,
            256,
        ),
        (
            "tool_call_explain_max_chars",
            |b| b.tool_call_explain.tool_call_explain_max_chars,
            1,
            4000,
        ),
    ]
...
fn u64_range_rows_b() -> &'static [U64RangeRow] {
    &[
        (
            ...
            |b| b.long_term_memory.long_term_memory_max_entries,
            1,
            100_000,
        ),
        (
            "long_term_memory_inject_max_chars",
            |b| b.long_term_memory.long_term_memory_inject_max_chars,
            256,
            500_000,
        ),
        (
            "long_term_memory_top_k",
            |b| b.long_term_memory.long_term_memory_top_k,
            1,
            64,
        ),
        (
            "long_term_memory_max_chars_per_chunk",
            |b| b.long_term_memory.long_term_memory_max_chars_per_chunk,
            256,
            32_000,
        ),
        (
            "long_term_memory_min_chars_to_index",
            |b| b.long_term_memory.long_term_memory_min_chars_to_index,
            0,
            4096,
        ),
        (
            "long_term_memory_default_ttl_secs",
            |b| b.long_term_memory.long_term_memory_default_ttl_secs,
            0,
            365 * 86400 * 10,
        ),
        (
            "mcp_tool_timeout_secs",
            |b| b.mcp_client.mcp_tool_timeout_secs,
            1,
            u64::MAX,
        ),
        (
            "codebase_semantic_max_file_bytes",
            |b| b.codebase_semantic.codebase_semantic_max_file_bytes,
            4096,
            4 * 1024 * 1024,
        ),
        (
            "codebase_semantic_chunk_max_chars",
            |b| b.codebase_semantic.codebase_semantic_chunk_max_chars,
            256,
            16_000,
        ),
        (
            "codebase_semantic_top_k",
            |b| b.codebase_semantic.codebase_semantic_top_k,
            1,
            64,
        ),
        (
            "codebase_semantic_query_max_chunks",
            |b| b.codebase_semantic.codebase_semantic_query_max_chunks,
            0,
            2_000_000,
        ),
        (
            "codebase_semantic_rebuild_max_files",
            |b| b.codebase_semantic.codebase_semantic_rebuild_max_files,
            1,
            100_000,
        ),
        (
            "codebase_semantic_fts_top_n",
            |b| b.codebase_semantic.codebase_semantic_fts_top_n,
            1,
            10_000,
        ),
        (
            "codebase_semantic_hybrid_semantic_pool",
            |b| b.codebase_semantic.codebase_semantic_hybrid_semantic_pool,
            1,
            10_000,
        ),
        (
...
fn validate_u64_table(b: &ConfigBuilder) -> Result<(), String> {
    for &(key, get, lo, hi) in u64_range_rows_a1() {
        check_u64_inclusive(key, get(b), lo, hi)?;
    }
    for &(key, get, lo, hi) in u64_range_rows_a2() {
        check_u64_inclusive(key, get(b), lo, hi)?;
    }
...
fn validate_f64_table(b: &ConfigBuilder) -> Result<(), String> {
    const ROWS: &[F64RangeRow] = &[
        ("temperature", |b| b.llm_sampling.temperature, 0.0, 2.0),
        (
            "agent_tool_stats_warn_below_success_ratio",
            |b| b.agent_tool_stats.agent_tool_stats_warn_below_success_ratio,
            0.0,
            1.0,
        ),
        (
            "codebase_semantic_hybrid_alpha",
            |b| b.codebase_semantic.codebase_semantic_hybrid_alpha,
            0.0,
            1.0,
        ),
    ];
