...
pub fn apply_hot_reload_config_subset(dst: &mut AgentConfig, src: &AgentConfig) {
    ...
    dst.agent_thinking_trace_enabled = src.agent_thinking_trace_enabled;
    ...
    dst.codebase_semantic_hybrid_alpha = src.codebase_semantic_hybrid_alpha;
    dst.codebase_semantic_fts_top_n = src.codebase_semantic_fts_top_n;
    dst.codebase_semantic_hybrid_semantic_pool = src.codebase_semantic_hybrid_semantic_pool;
    ...
    dst.intent_l2_enabled = src.intent_l2_enabled;
    dst.intent_l2_min_confidence = src.intent_l2_min_confidence;
    ...
    dst.intent_non_hier_execute_low_threshold = src.intent_non_hier_execute_low_threshold;
    dst.intent_non_hier_execute_high_threshold = src.intent_non_hier_execute_high_threshold;
    dst.intent_at_turn_start_enabled = src.intent_at_turn_start_enabled;
