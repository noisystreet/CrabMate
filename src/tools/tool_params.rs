...
pub(super) fn params_code_stats() -> serde_json::Value {
    serde_json::json!({
        "type":"object",
        "properties":{
...
pub(super) fn params_dependency_graph() -> serde_json::Value {
    serde_json::json!({
        "type":"object",
        "properties":{
...
pub(super) fn params_coverage_report() -> serde_json::Value {
    serde_json::json!({
        "type":"object",
        "properties":{
...
pub(super) fn params_shellcheck_check() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
        "properties": {
...
pub(super) fn params_cppcheck_analyze() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
        "properties": {
...
pub(super) fn params_semgrep_scan() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
        "properties": {
...
pub(super) fn params_hadolint_check() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
        "properties": {
...
pub(super) fn params_bandit_scan() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
        "properties": {
...
pub(super) fn params_lizard_complexity() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
        "properties": {
