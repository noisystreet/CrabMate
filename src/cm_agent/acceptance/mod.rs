...
pub use tool_evidence::verify_plan_step_acceptance_for_tool_message;
...
pub enum FileResolveKind {
    /// `crate::cm_tools::workspace::path::absolutize_relative_under_root`（分阶段 `PlanStepAcceptance`）。
    #[default]
    AbsolutizeRelative,
...
pub struct AcceptanceSpec {
    ...
    pub expect_json_path_equals: Option<crate::cm_agent::plan_artifact::JsonPathEqualsRule>,
...
impl From<&crate::cm_agent::plan_artifact::PlanStepAcceptance> for AcceptanceSpec {
    fn from(a: &crate::cm_agent::plan_artifact::PlanStepAcceptance) -> Self {
...
pub struct AcceptanceEvidence<'a> {
    ...
    pub stdout: &'a str,
    pub stderr: &'a str,
    pub tool_error: Option<&'a crate::cm_tools::tool_result::ToolError>,
