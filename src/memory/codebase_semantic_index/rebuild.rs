...
pub(crate) struct RebuildIndexParams<'a> {
    pub(crate) ws_root: &'a Path,
    pub(crate) ws_key: &'a str,
    pub(crate) index_path: &'a Path,
    pub(crate) sub_path: Option<&'a str>,
    pub(crate) max_file_bytes: usize,
    pub(crate) chunk_max_chars: usize,
    pub(crate) rebuild_max_files: usize,
    pub(crate) ext_set: &'a HashSet<String>,
    pub(crate) file_glob_pat: Option<&'a glob::Pattern>,
    pub(crate) incremental: bool,
}

pub(crate) fn rebuild_index(p: RebuildIndexParams<'_>) -> String {
