...
fn apply_tool_registry_tool_lists(
    ...
    p.tool_registry_tool_retry_enabled = tr
        .tool_retry_enabled
        .or(p.tool_registry_tool_retry_enabled);
    p.tool_registry_tool_retry_max_attempts = tr
        .tool_retry_max_attempts
        .or(p.tool_registry_tool_retry_max_attempts);
    p.tool_registry_tool_retry_backoff_ms = tr
        .tool_retry_backoff_ms
        .or(p.tool_registry_tool_retry_backoff_ms);
    if let Some(v) = tr.tool_retry_error_codes {
        p.tool_registry_tool_retry_error_codes = Some(v);
    }
