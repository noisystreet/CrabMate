...
//!
//! 与 `llm::api::stream_chat` 下发的纯文本 delta 区分；前端对齐见 `frontend/src/api.rs`。
//!
//! 人读契约见仓库 **`docs/SSE协议.md`**。协议版本常量见 **`protocol::SSE_PROTOCOL_VERSION`**（workspace crate **`crabmate-sse-protocol`**，与 Leptos **`frontend/src/api.rs`** 同源）。
//!
