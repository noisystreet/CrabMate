...
impl ReadFileTurnCache {
    ...
    pub fn try_get(&self, key: &str, modified: SystemTime, len: u64) -> Option<String> {
    ...
    pub fn insert(&self, key: String, modified: SystemTime, len: u64, output: String) {
