...
use crate::cm_tools::tools::markdown_links::core::{LinkIssue, RULE_ROOT, collect_markdown_files};
use crate::cm_tools::workspace::path::canonical_workspace_root;
...
pub(super) fn markdown_check_collect_files(
    ...
    let http_client = if parsed.allowed_prefixes.is_empty() {
        ...
        Some(
            crate::cm_tools::tools::markdown_links::core::build_http_client(timeout)
