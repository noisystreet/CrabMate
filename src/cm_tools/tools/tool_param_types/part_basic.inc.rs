...
impl GetCurrentTimeMode {
    pub fn to_time_output(self) -> crate::cm_tools::tools::time::TimeOutputMode {
        match self {
            Self::Time => crate::cm_tools::tools::time::TimeOutputMode::Time,
            Self::Calendar => crate::cm_tools::tools::time::TimeOutputMode::Calendar,
            Self::Both => crate::cm_tools::tools::time::TimeOutputMode::Both,
        }
    }
}
