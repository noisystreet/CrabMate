...
ToolSpec {
            ...
            parameters: schema_of::<args::NpmInstallArgs>,
            runner: ToolRunner::Legacy(runner_npm_install),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::NpmRunArgs>,
            runner: ToolRunner::Legacy(runner_npm_run),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::NpxRunArgs>,
            runner: ToolRunner::Legacy(runner_npx_run),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::TscCheckArgs>,
            runner: ToolRunner::Legacy(runner_tsc_check),
