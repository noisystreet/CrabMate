...
ToolSpec {
            ...
            parameters: schema_of::<args::RegexTestArgs>,
            runner: ToolRunner::Legacy(runner_regex_test),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Basic,
            parameters: schema_of::<args::DateCalcArgs>,
            runner: ToolRunner::Legacy(runner_date_calc),
            summary: ToolSummaryKind::None,
        },
        ToolSpec {
            name: "json_format",
            ...
            category: ToolCategory::Basic,
            parameters: schema_of::<args::JsonFormatArgs>,
            runner: ToolRunner::Legacy(runner_json_format),
            summary: ToolSummaryKind::None,
        },
        ToolSpec {
            name: "env_var_check",
            ...
            category: ToolCategory::Basic,
            parameters: schema_of::<args::EnvVarCheckArgs>,
            runner: ToolRunner::Legacy(runner_env_var_check),
            summary: ToolSummaryKind::None,
        },
        ToolSpec {
            name: "todo_scan",
            ...
            parameters: schema_of::<args::TodoScanArgs>,
