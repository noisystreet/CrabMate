[
        ToolSpec {
            ...
            parameters: schema_of::<args::SelfConfigInfoArgs>,
            runner: ToolRunner::Legacy(runner_self_config_info),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::SkillManageArgs>,
            runner: ToolRunner::Legacy(runner_skill_manage),
