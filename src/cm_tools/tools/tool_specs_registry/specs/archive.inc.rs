[
    ToolSpec {
        ...
        parameters: schema_of::<args::ArchivePackArgs>,
        runner: ToolRunner::Legacy(runner_archive_pack),
    ...
    ToolSpec {
        ...
        category: ToolCategory::Development,
        parameters: schema_of::<args::ArchiveUnpackArgs>,
        runner: ToolRunner::Legacy(runner_archive_unpack),
    ...
    ToolSpec {
        ...
        category: ToolCategory::Development,
        parameters: schema_of::<args::ArchiveListArgs>,
        runner: ToolRunner::Legacy(runner_archive_list),
