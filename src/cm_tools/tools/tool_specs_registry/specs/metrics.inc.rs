...
ToolSpec {
            ...
            parameters: schema_of::<args::CodeStatsArgs>,
            runner: ToolRunner::Legacy(runner_code_stats),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::DependencyGraphArgs>,
            runner: ToolRunner::Legacy(runner_dependency_graph),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::CoverageReportArgs>,
            runner: ToolRunner::Legacy(runner_coverage_report),
