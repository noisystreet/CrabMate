...
ToolSpec {
            ...
            parameters: schema_of::<args::MarkdownCheckLinksArgs>,
            runner: ToolRunner::Legacy(runner_markdown_check_links),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::StructuredValidateArgs>,
            runner: ToolRunner::Legacy(runner_structured_validate),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::StructuredQueryArgs>,
            runner: ToolRunner::Legacy(runner_structured_query),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::StructuredDiffArgs>,
            runner: ToolRunner::Legacy(runner_structured_diff),
        ...
        ToolSpec {
            ...
            category: ToolCategory::Development,
            parameters: schema_of::<args::StructuredPatchArgs>,
            runner: ToolRunner::Legacy(runner_structured_patch),
