...
pub(in crate::cm_tools::tools) fn params_backtrace_analyze() -> serde_json::Value {
    tool_parameters_schema_value::<BacktraceAnalyzeArgs>()
}

pub(in crate::cm_tools::tools) fn params_ci_pipeline_local() -> serde_json::Value {
    tool_parameters_schema_value::<CiPipelineLocalArgs>()
}

pub(in crate::cm_tools::tools) fn params_release_ready_check() -> serde_json::Value {
    tool_parameters_schema_value::<ReleaseReadyCheckArgs>()
}

pub(in crate::cm_tools::tools) fn params_workflow_execute() -> serde_json::Value {
