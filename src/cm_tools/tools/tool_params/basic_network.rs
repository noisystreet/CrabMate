...
pub(in crate::cm_tools::tools) fn params_get_current_time() -> serde_json::Value {
    tool_parameters_schema_value::<GetCurrentTimeArgs>()
}

pub(in crate::cm_tools::tools) fn params_calc() -> serde_json::Value {
    tool_parameters_schema_value::<CalcArgs>()
}

pub(in crate::cm_tools::tools) fn params_convert_units() -> serde_json::Value {
    tool_parameters_schema_value::<ConvertUnitsArgs>()
}

pub(in crate::cm_tools::tools) fn params_weather() -> serde_json::Value {
    tool_parameters_schema_value::<GetWeatherArgs>()
}

pub(in crate::cm_tools::tools) fn params_web_search() -> serde_json::Value {
    tool_parameters_schema_value::<WebSearchArgs>()
}

pub(in crate::cm_tools::tools) fn params_http_fetch() -> serde_json::Value {
    tool_parameters_schema_value::<HttpFetchArgs>()
}

pub(in crate::cm_tools::tools) fn params_http_request() -> serde_json::Value {
    tool_parameters_schema_value::<HttpRequestArgs>()
}

pub(in crate::cm_tools::tools) fn params_text_transform() -> serde_json::Value {
    tool_parameters_schema_value::<TextTransformArgs>()
}

pub(in crate::cm_tools::tools) fn params_regex_test() -> serde_json::Value {
    tool_parameters_schema_value::<RegexTestArgs>()
}

pub(in crate::cm_tools::tools) fn params_date_calc() -> serde_json::Value {
    tool_parameters_schema_value::<DateCalcArgs>()
}

pub(in crate::cm_tools::tools) fn params_json_format() -> serde_json::Value {
    tool_parameters_schema_value::<JsonFormatArgs>()
}

pub(in crate::cm_tools::tools) fn params_env_var_check() -> serde_json::Value {
