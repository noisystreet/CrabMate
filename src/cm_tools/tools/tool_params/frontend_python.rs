...
pub(in crate::cm_tools::tools) fn params_frontend_lint() -> serde_json::Value {
    tool_parameters_schema_value::<FrontendLintArgs>()
}

pub(in crate::cm_tools::tools) fn params_ruff_check() -> serde_json::Value {
    tool_parameters_schema_value::<RuffCheckArgs>()
}

pub(in crate::cm_tools::tools) fn params_pytest_run() -> serde_json::Value {
    tool_parameters_schema_value::<PytestRunArgs>()
}

pub(in crate::cm_tools::tools) fn params_mypy_check() -> serde_json::Value {
    tool_parameters_schema_value::<MypyCheckArgs>()
}

pub(in crate::cm_tools::tools) fn params_python_install_editable() -> serde_json::Value {
    tool_parameters_schema_value::<PythonInstallEditableArgs>()
}

pub(in crate::cm_tools::tools) fn params_uv_sync() -> serde_json::Value {
    tool_parameters_schema_value::<UvSyncArgs>()
}

pub(in crate::cm_tools::tools) fn params_uv_run() -> serde_json::Value {
    tool_parameters_schema_value::<UvRunArgs>()
}

pub(in crate::cm_tools::tools) fn params_python_snippet_run() -> serde_json::Value {
