...
//!
//! 状态存放在 [`ToolOutcomeRecorder`] 中，由 Web/CLI 入口构造并经 [`crate::cm_internal::RunAgentTurnParams`] 与
//! [`crate::cm_internal::process_handles::ProcessHandles`] 显式传递，**不**使用模块级 `static`。
//!
