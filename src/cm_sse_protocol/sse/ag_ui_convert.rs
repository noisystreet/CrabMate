...
mod tests {
    use super::*;
    use crate::cm_sse_protocol::sse::protocol::StreamEndReason;
    use crate::cm_sse_protocol::sse::protocol::{
        ...
        let test_cases: Vec<(SsePayload, &str)> = vec![
            ...
            (
                SsePayload::StreamDraining {
                    draining: crate::cm_sse_protocol::sse::protocol::StreamDrainingBody {
                        job_id: 9,
                    },
                },
                "stream_draining",
        ...
        let payloads: Vec<(SsePayload, &str)> = vec![
            ...
            (
                SsePayload::SseCapabilities {
                    caps: SseCapabilitiesBody {
                        ...
                        job_id: 1,
                        terminal_order: Some(
                            crate::cm_sse_protocol::SSE_TERMINAL_ORDER_SAVED_BEFORE_FINISHED
                                .to_string(),
                        ),
                    },
                },
            ...
            (
                SsePayload::StreamEnded {
                    ended: StreamEndedBody {
                        job_id: 1,
                        reason: crate::cm_sse_protocol::StreamEndReason::Completed,
                        tiktoken_prompt_tokens: None,
                    },
                },
                "RUN_FINISHED",
