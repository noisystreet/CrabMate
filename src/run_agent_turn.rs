    ...
    let mut loop_params = crate::agent::agent_turn::RunLoopParams {
        ctx: crate::agent::agent_turn::RunLoopCtx {
            ...
            attach: crate::agent::agent_turn::RunLoopAttach {
                ...
                staged_plan_optimizer_round: true, // L1 硬编码：DEFAULT_STAGED_PLAN_OPTIMIZER_ROUND
                staged_plan_optimizer_requires_parallel_tools: false, // L1 硬编码
                staged_plan_ensemble_count: 1,     // L1 硬编码：DEFAULT_STAGED_PLAN_ENSEMBLE_COUNT
                staged_plan_skip_ensemble_on_casual_prompt: true, // L1 硬编码
