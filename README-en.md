...
- **OpenAPI**: `serve` exposes **`GET /openapi.json`** (OpenAPI 3.0, `application/json`) for machine-readable HTTP shapes; **SSE line protocol** for `/chat/stream` remains in [docs/en/SSE_PROTOCOL.md](docs/en/SSE_PROTOCOL.md).
