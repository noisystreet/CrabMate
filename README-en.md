...
- **Workspace**: must stay under allowed roots; on Unix, **`openat2`** etc. reduce path risk—**not** a full sandbox. See [docs/en/CONFIGURATION.md](docs/en/CONFIGURATION.md), [`src/workspace/path.rs`](src/workspace/path.rs).
