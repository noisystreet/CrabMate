...
| [docs/STAGED_PLAN_SINGLE_STEP_DESIGN.md](docs/STAGED_PLAN_SINGLE_STEP_DESIGN.md) | Staged plan: at most one planner `step` per round — design (not implemented) | [zh](docs/STAGED_PLAN_SINGLE_STEP_DESIGN.md) |
